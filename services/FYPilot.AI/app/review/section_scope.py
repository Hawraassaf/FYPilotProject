...
_SECTION_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "databasedesign": ("databaseEntities", "entityRelationships"),
    "database design": ("databaseEntities", "entityRelationships"),
    "databaseentities": ("databaseEntities",),
    "database entities": ("databaseEntities",),
    "databaserelationships": ("entityRelationships",),
    "database relationships": ("entityRelationships",),
